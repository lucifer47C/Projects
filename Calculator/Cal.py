...
class Calculator:
    def __init__(self):
        ...
        icon = PhotoImage(file = 'C:/Users/STEVE YADAV/Downloads/Code/Python/Calculator/Calculator.png')   
    ...
    def create_special_buttons(self):
        ...
        self.create_clear_current_display_button()
    ...
    def create_percentage_button(self):
        button = tk.Button(self.buttons_frame, text="%", bg=OFF_WHITE, fg=LABEL_COLOR, font=SMALL_FONT_STYLE,
    ...
    def create_clear_current_display_button(self):
        button = tk.Button(self.buttons_frame, text="CE", bg=OFF_WHITE, fg=LABEL_COLOR, font=SMALL_FONT_STYLE,
                           borderwidth=0, command=self.clear_current_display)
    ...
    def create_clear_button(self):
        button = tk.Button(self.buttons_frame, text="C", bg=OFF_WHITE, fg=LABEL_COLOR, font=SMALL_FONT_STYLE,
    ...
    def create_reciprocal_button(self):
        button = tk.Button(self.buttons_frame, text="\u215Fx", bg=OFF_WHITE, fg=LABEL_COLOR, font=SMALL_FONT_STYLE,
